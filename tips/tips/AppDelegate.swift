...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  func applicationDidEnterBackground(_ application: UIApplication) {
    ...
    sharedDefaults.set(Date(timeIntervalSinceNow: 600), forKey: "appExitDate")  // sets the appExitDate for now plus 10 minutes
    sharedDefaults.set(rootView.billField.text!, forKey: "appExitBillAmount")
